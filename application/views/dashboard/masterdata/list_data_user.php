...
<body class="app sidebar-mini">
                ...
                <div class="tile">
                    <div class="row ">
                        ...
                        <div class="col-auto">
                            ...
                            <button class="btn btn-primary btn-xs" type="button" data-toggle="modal" data-target="#AddUser"><i class="fa fa-plus"></i> Tambah User</button>
                        </div>
                    </div>
    ...
    <?php $this->load->view('dashboard/masterdata/form_tambah_user') ?>
</body>
...
<script type="text/javascript">
    ...
    function CariPosyandu(value) {
        table = $('#listdataposyandu').DataTable({
            ...
            "ajax": {
                url: domain + "serverside/list_data_user",
                type: "POST",
                data: {}
            },
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.ajax({
                            method: 'post',
                            url: domain + "proses/delete_data_user",
                            data: {
                                id: id,
                            },
    ...
    function TambahDataPosyandu() {
        ...
        if (username.length == 0) {
            ...
            $.ajax({
                type: 'POST',
                url: domain + "proses/simpan_data_user",
                data: formData,
                cache: false,
                processData: false,
                contentType: false,
